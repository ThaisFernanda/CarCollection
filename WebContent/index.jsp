			...
			<ul>
				...
				<li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
					...
					<div class="tp-caption banner21 tp-fade tp-resizeme"
						...
						<h3>ESTÁ PROCURANDO CARROS ANTIGOS? </h3>
					</div>
					...
					<div class="tp-caption banner2 tp-fade tp-resizeme"
						...
						data-endspeed="300"
						>
						<!--  <a class="slide_btn" href="#" style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;font-size:16px; color:#fff;border: 2px solid #ffffff;line-height:2;padding: 10px 30px;">Detalhes</a>-->
					</div>
				</li>
				<!-- SLIDE-2 -->
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">	
							<div class="single_review">
								...
								<h5>Michell Wilson</h5>
								<p>Ó“timo sistema. Consegui realizar meu sonhar e comprar um Ford Galaxie Landau 1979. A Equipe está de parabéns!</p>
						...
						<div class="item">
							<div class="single_review">
								...
								<h5>Vanessa Barbosa</h5>
								<p>Incrível! Anunciei meu Cadillac Fleetwood e em apenas duas semanas estava fechando negócio com o novo proprietário.</p>
								<div class="review_line"></div>
								<div class="review_icon">
									<i>"</i>
								</div>
						...
						<div class="item">
							<div class="single_review">
								...
								<h5>Jonas Kaio</h5>
								<p>Excelente trabalho! Estava procurando um site de carros antigos e só aqui consegui encontrar tudo o que eu buscava!</p>
								<div class="review_line"></div>
								<div class="review_icon">
									<i>"</i>
								</div>
